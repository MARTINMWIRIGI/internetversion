          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-cyan-300 text-xl md:text-2xl font-bold">{stat.value}</p>
              </motion.div>
            );
          })}
        </div>
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
      {[
        ...
        const colorClass = colorClasses[layer.color];
        ...
        return (
          ...
          >
            ...
            <Link href={`/vault?layer=${layer.id}`}>
              <button 
                className={`w-full py-3 px-4 rounded-xl font-mono text-sm font-bold transition-all duration-300 bg-gradient-to-r ${colorClass.gradientFrom} ${colorClass.gradientTo} hover:opacity-90 hover:shadow-lg hover:${colorClass.shadow} flex items-center justify-center`}
              >
      ...
      <div className="bg-black/40 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8">
        ...
        <div className="space-y-4">
          {[
            ...
            const colorClass = colorClasses[vault.color];
            return (
...
<section id="blockchain" className="py-16 md:py-24 px-4 md:px-8 lg:px-16">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* SECTION 8: USE CASES */}
      <section id="use-cases" className="relative scroll-mt-28 py-16 md:py-24 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-transparent to-black/30">
        <span id="goal" className="absolute -top-24" aria-hidden="true" />
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              const colorClass = colorClasses[useCase.color];
